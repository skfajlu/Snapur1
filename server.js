...
app.get('/:code', async (req, res) => {
  ...
  // ── Monetag 9 zones — sab properly working types ──
  // Zone 1: Popunder, Zone 2: In-Page Push, Zone 3: Push, Zone 4: Vignette,
  // Zone 5-9: more popunder/push variants — ALL async, non-blocking
  const _MZ = [
    '<script src="https://quge5.com/88/tag.min.js" data-zone="247764" async data-cfasync="false"></script>',  // In-Page Push
    '<script src="https://quge5.com/88/tag.min.js" data-zone="246895" async data-cfasync="false"></script>',  // Zone 2
    '<script src="https://quge5.com/88/tag.min.js" data-zone="248162" async data-cfasync="false"></script>',  // Zone 3
    '<script src="https://quge5.com/88/tag.min.js" data-zone="248564" async data-cfasync="false"></script>',  // Zone 4
    '<script src="https://quge5.com/88/tag.min.js" data-zone="248565" async data-cfasync="false"></script>',  // Zone 5
    '<script async data-cfasync="false" src="https://5gvci.com/act/files/tag.min.js?z=11114829"></script>',  // Zone 6
    '<script async data-cfasync="false" src="https://5gvci.com/act/files/tag.min.js?z=11117663"></script>',  // Zone 7
    '<script>(function(s){s.dataset.zone="11114819",s.src="https://al5sm.com/tag.min.js";document.body.appendChild(s)})(document.createElement("script"))</script>',  // Zone 8
    '<script>(function(s){s.dataset.zone="11126180",s.src="https://al5sm.com/tag.min.js"})([document.documentElement,document.body].filter(Boolean).pop().appendChild(document.createElement("script")))</script>',  // Zone 9
  ];
  let _mi = 0;

  // nextAd() — Monetag zone rotate karke dikhata hai, page block nahi karta
  function nextAd() {
    const z = _MZ[_mi++ % _MZ.length];
    return '<div style="margin:12px 0;text-align:center;min-height:50px">' + z + '</div>';
  }
  // exoAd() — same rotation (Adsterra hataye, sirf Monetag)
  function exoAd() {
    return nextAd();
  }

  // ── PAGE_ADS_SCRIPT: Popunder + Push + Vignette — body end mein, ZERO delay ──
  // Yeh scripts timer/button ke BAAD inject honge taaki page freeze na ho
  ...
  const CSS = `
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    /* ── AD ISOLATION: Koi bhi ad captcha/button ko block nahi karega ── */
    /* Saare iframes low z-index pe rahenge */
    iframe{z-index:1 !important}
    /* Ad overlays jo fixed position mein aate hain — pointer-events off */
    body > div[style*="position: fixed"],
    body > div[style*="position:fixed"],
    body > iframe{pointer-events:none !important;z-index:1 !important}
    /* Monetag in-page push containers */
    div[id^="mn_"]{z-index:1 !important}
    /* Hamari important cheezein — HAMESHA upar */
    ...
    .btn,#continueBtn,#finalBtn,#generateBtn{
      isolation:isolate !important;
      z-index:2147483646 !important;
      position:relative !important;
      pointer-events:auto !important;
    ...
    .timer-box,.generate-box{
      position:relative !important;
      z-index:100 !important;
    }
  `;

  // PAGE_ADS_SCRIPT: Monetag Popunder + Push + Vignette
  // Seedha script tags — async hain toh page block nahi karenge
...
function doCaptcha() {
  ...
  // Pehle UI update karo — instant response
  ...
  // Popup baad mein (user gesture already hai is click pe)
  try { window.open('${MONETAG_SMART}', '_blank'); } catch(e){}
}
function goContinue() {
  if (!captchaDone) { alert('Please complete verification first!'); return; }
